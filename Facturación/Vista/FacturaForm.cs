    ...
    public partial class FacturaForm : Form
    {
        ...
        private void CantidadTextBox_KeyPress(object sender, KeyPressEventArgs e)
        {
            if (e.KeyChar == (char)Keys.Enter && !string.IsNullOrEmpty(CantidadTextBox.Text))
            {
                ...
                {
                    if (Convert.ToInt32(ExistenciaTextBox.Text) >= Convert.ToInt32(CantidadTextBox.Text)) //Validar si hay o no mas productos
                    {
                        ...
                        SubTotalTtextBox.Text = subTotal.ToString("N2"); //Agrega el simbolo de millares
                        ...
                        MessageBox.Show("No hay suficente existencia de: " + miProducto.Descripcion);
                }
                else
